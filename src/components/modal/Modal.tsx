...
export type ModalProps = {
  ...
  // makeOnceClose?: MakeWhenStateChange;
  makeOnceDataChange?: MakeWhenStateChange;
};

const ModalComponent = (_: unknown, ref: Ref<RefType>) => {
...
export const Modal = memo(forwardRef<RefType>(ModalComponent));
